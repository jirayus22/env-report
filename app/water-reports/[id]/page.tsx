...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      setForm({
        system_status: op.system_status ?? null,
        pump_status: op.pump_status ?? null,
      ...
      setMetrics({
        do_value: op.do_value?.toString() ?? "",
        sv30_value: op.sv30_value?.toString() ?? "",
        ph_value: op.ph_value?.toString() ?? "",
      });
